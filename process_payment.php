...
try {
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO orders (order_id, pooja_name, main_item_name, main_item_price, addons_json, custom_amount, total_amount, names_gotras_json, mobile, address1, address2, pincode, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())");
